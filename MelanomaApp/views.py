    ...
    if request.POST:
        ...
        if request.FILES.get("file"):
            ...
            for item in filedata:
                print(item.name)
            try:
                original = cv2.imread(r'C:\Users\krishnachandran\OneDrive\Desktop\Melanoma\MelanomaApp\static'+uploaded_file_url)
                contrast = cv2.imread(r"C:\Users\krishnachandran\OneDrive\Desktop\Melanoma\images\dermquest/"+filename)
